  ...
  return (
    <div style={pageStyle}>
      <div style={containerStyle}>
        ...
        <h2 style={sectionTitleStyle}>2. Inscription et compte utilisateur</h2>
        <p style={textStyle}>
        ...
        <h2 style={sectionTitleStyle}>3. Types de comptes</h2>
        ...
        <h2 style={sectionTitleStyle}>4. Obligations des utilisateurs</h2>
        ...
        <h2 style={sectionTitleStyle}>5. Contenu utilisateur</h2>
        <p style={textStyle}>
        ...
        <h2 style={sectionTitleStyle}>7. Responsabilité</h2>
        <p style={textStyle}>
        ...
        <h2 style={sectionTitleStyle}>8. Tarification</h2>
        <p style={textStyle}>
        ...
        <h2 style={sectionTitleStyle}>9. Suspension et résiliation</h2>
        <p style={textStyle}>
        ...
        <h2 style={sectionTitleStyle}>10. Protection des données</h2>
        <p style={textStyle}>
        ...
        <h2 style={sectionTitleStyle}>11. Modification des CGU</h2>
        <p style={textStyle}>
        ...
        <h2 style={sectionTitleStyle}>12. Droit applicable et juridiction</h2>
        <p style={textStyle}>
        ...
        <h2 style={sectionTitleStyle}>13. Médiation des litiges</h2>
        <p style={textStyle}>
        ...
        <h2 style={sectionTitleStyle}>15. Contact</h2>
        <p style={textStyle}>
          Pour toute question concernant ces CGU, vous pouvez nous contacter à : <strong>[email à compléter]</strong>
        </p>
